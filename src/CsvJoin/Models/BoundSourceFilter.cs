    ...
    ColumnDataType DataType = ColumnDataType.Text)
{
    ...
    public bool Matches(CsvDataRow row)
    {
        ...
        return Operator switch
        {
            ...
            SourceFilterOperator.GreaterThan => Compare(value, Value, DataType) > 0,
            SourceFilterOperator.GreaterThanOrEqual => Compare(value, Value, DataType) >= 0,
            SourceFilterOperator.LessThan => Compare(value, Value, DataType) < 0,
            SourceFilterOperator.LessThanOrEqual => Compare(value, Value, DataType) <= 0,
    ...
    internal static int Compare(string? rowValue, string? filterValue, ColumnDataType dataType)
    {
